  ...
  <div class="py-20 px-20 flex items-center mt-2">
    <div class="flex-[1] space-y-8">
      ...
      <p class="text-3xl font-medium max-w-sm leading-tight">
        They truly listened to our ideas and turned them into something better
      ...
      <div class="flex items-center space-x-4">
        ...
        <div>
          <p class="text-xs font-bold">Katherine Moss</p>
          <span class="text-xs font-light">Project Manager, Layers</span>
        </div>
      </div>
    </div>
