...
<template>
  <div class="hidden lg:flex flex-col bg-navbar-color font-inter w-full">
    ...
    <!--third layout -->
    <div
      class="flex justify-center items-center border-b border-black mt-4 text-xs"
    >
      <div class="flex items-center gap-20 uppercase">
        ...
        <div class="relative inline-block text-left">
          ...
          >
            <div>
              <span
                ...
                ><NuxtLink to="/services">Services</NuxtLink></span
              >
            </div>
            <svg
          ...
          <div
            v-if="isServiceOpen"
            class="absolute left-[-33rem] z-10 mt-[1px] w-[96rem] origin-top-right bg-navbar-color border border-black border-t-0 border-opacity-20 rounded-bl-[25px] rounded-br-[25px] shadow-custom-light space-y-4"
          >
            <!-- Dropdown content -->
            <div class="py-1 flex flex-row gap-10 px-10 mt-5 mb-5">
              ...
              >
                ...
                <div
                  class="w-[300px] h-[154px] mt-7 ml-20 bg-[#A89C93] rounded-tl-[20px] rounded-tr-[20px] custom-cursor-button"
                >
              ...
              >
                ...
                <div
                  class="w-[300px] h-[154px] mt-7 ml-20 bg-[#665244] rounded-tl-[20px] rounded-tr-[20px]"
                >
                  <img
                    :src="image2"
                    alt="second image"
                  ...
                  >
                    ...
                    <div class="mt-[50px]">
                      <img
                        :src="allButton"
                        alt="arrow"
                        class="h-[105px] w-[105px] cursor-pointer"
                      />
                    </div>
                  </div>
                </div>
        ...
        >
          <NuxtLink to="/portfolio">Gallery</NuxtLink>
        </p>
        <p
          class="text-xs"
          :class="{
