...
<template>
  ...
  <div class="flex flex-col bg-navbar-color cont">
    <!-- first layout -->
    <PopUpModal />

    <!-- second layout  -->
    <div
      class="flex flex-row mt-6 justify-between text-sm sm:text-base md:text-lg lg:text-[12px] seccont"
    >
      <div
    ...
    <!--third layout -->
    <div
      class="flex justify-center items-center border-b border-black mt-6 text-sm sm:text-base md:text-lg lg:text-[13px] thirdcont"
    >
      <div class="flex flex-row items-center gap-16 uppercase">
        <p
          ...
          :class="{
            'cursor-pointer': true,
            'underline-black':
              underlineText === 'Home' && activeDropdown === null,
          }"
        >
          Home
        </p>
        ...
        <div class="relative inline-block text-left">
          <!-- Selected Option -->
          <div
            class="bg-navbar-color uppercase inline-flex items-center justify-between w-full p-2"
            ...
            <div>
              <span
                ...
                :class="{
                  'cursor-pointer': true,
                  'underline-black2':
                    underlineText === 'Services' && activeDropdown === null,
                }"
                >Services</span
              >
            </div>
          ...
          <div
            v-if="isServiceOpen"
            class="absolute left-[-33rem] lg:left-[-17rem] z-10 mt-[1px] lg:w-[70rem] origin-top-right bg-navbar-color border border-black border-t-0 border-opacity-20 rounded-bl-[25px] rounded-br-[25px] shadow-custom-light space-y-4 select-cont"
          >
            <!-- Dropdown content -->
            <div class="py-1 flex flex-row gap-10 px-10 mt-5 mb-5">
              ...
              <button
                ...
                class="block w-full text-left px-4 py-2 border border-solid border-[#E4DBD1] h-[251px] rounded-[25px] group hover:bg-black f-cont"
              >
              ...
              <button
                @click="selectOption('More')"
                class="block w-full text-left px-4 py-2 border border-solid border-[#E4DBD1] h-[251px] rounded-[25px] group hover:bg-black"
              >
              ...
              <div
                @click="selectOption('More')"
                class="block w-full text-left h-[251px] rounded-[25px]"
              >
                <div class="">
                  <div
                  ...
                  >
                    <div class="flex flex-col gap-4">
                      <h4
                        class="text-[black] font-[600] text-[14px] mt-4 header1"
                      >
                        More Services
                      </h4>
                      <p class="font-[400] text-[13px] cursor-pointer txt1">
                        Pools and Spas
                      </p>
                      <p class="font-[400] text-[13px] cursor-pointer">
                        Outdoor Kitchens
                      </p>
                      <p class="font-[400] text-[13px] cursor-pointer">
                        Concrete San Diego
        ...
        >
          <!-- Selected Option -->
          <button
            class="bg-navbar-color uppercase cursor-pointer inline-flex items-center justify-between w-full p-2"
          ...
          <div
            v-if="isMoreOpen"
            class="absolute left-[-54rem] z-10 mt-[1px] w-[71rem] origin-top-right bg-navbar-color border border-black border-t-0 border-opacity-20 rounded-bl-[25px] rounded-br-[25px] shadow-custom-light space-y-4 more-dropdown"
          >
            <!-- Dropdown content -->
            <div class="py-1 flex flex-row gap-10 px-10 mt-5 mb-5">
              <!-- first container -->
              <button
                @click="selectOption('More')"
                class="block w-[30%] text-left px-4 py-2 border border-solid border-[#E4DBD1] h-[251px] rounded-[25px] more-parent"
              >
                <div class="ml-3 mt-2">
