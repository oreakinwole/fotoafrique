   ...
   <div class="bg-[#F8F5F3] w-full pt-20 pb-1 mt-40">
    <div class="flex flex-col justify-center items-center">
      ...
      <div class="px-32 my-20 h-[600px] relative ">
        <ImgComparisonSlider class="h-full rounded-2xl shadow-2xl">
          <!-- eslint-disable -->
          <img
            slot="first"
        ...
        >
          <div class="flex flex-row ml-12">
            <div class="absolute">
              <img
                src="/images/homethirdsegment/imgs/img.svg"
                alt="customer picture"
              />
            </div>

            <div class="relative ml-[-47px]">
              <img src="/images/homethirdsegment/icons/cir.svg" alt="circle" />
            </div>
          </div>
