...
import HomeThirdSegment from "~/components/features/HomeThirdSegment/index.vue";
...
export default defineComponent({
  components: {NavBar, HomeLastSegment, HomeThirdSegment, HomeSecondSegment, Footer, Hero},
  name : 'Home'
})
</script>
